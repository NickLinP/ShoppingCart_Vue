    ...
    <div class="">
      ...
      <div class="row" style="background-color: rgb(227, 104, 135)">
        ...
        <div class="col-lg-12 col-xl-8">
          <img
            class="middle"
            width="100%"
            src="../image/homepage/ff567e05c936d11121d23e2b19792cf3_compressed_1.jpg"
          />
        </div>
        <div class="col-xl-2"></div>
      </div>
            ...
            <div class="d-flex align-content-start flex-wrap">
              <div class="listItem">
                <a href="">
                  <img
                    id="listItem0"
                    src="../image/homepage/ed992fc80829327663a94cc4d0527e0e.jpg"
                    alt=""
                  />
                </a>
              </div>
              ...
              <div class="listItem">
                <a href="">
                  <img
                    id="listItem1"
                    src="../image/homepage/fdc83f8b1b004f144c59c6149a8d1004.jpg"
                    alt=""
                  />
                </a>
              </div>
              ...
              <div class="listItem">
                <a href="">
                  <img
                    id="listItem2"
                    src="../image/homepage/ac0bf72c79d12f266d73bf40587aa046_1.jpg"
                    alt=""
                  />
                </a>
              </div>
              ...
              <div class="listItem">
                <a href="">
                  <img
                    id="listItem3"
                    src="../image/homepage/45c3ab5b100ad9386cba3ffb490446c4_1.jpg"
                    alt=""
                  />
                </a>
              </div>
              ...
              <div class="listItem">
                <a href="">
                  <img
                    id="listItem4"
                    src="../image/homepage/c2195def7236fbc66536b53e1d2ea46f_1.jpg"
                    alt=""
                  />
                </a>
              </div>
              ...
              <div class="listItem">
                <a href="">
                  <img
                    id="listItem5"
                    src="../image/homepage/10f9646b8e85f4c2b54da6f7fa229b32.jpg"
                    alt=""
                  />
                </a>
              </div>
              ...
              <div class="listItem">
                <a href="">
                  <img
                    id="listItem6"
                    src="../image/homepage/948fea9e439450e836268702b086c856_1.jpg"
                    alt=""
                  />
                </a>
              </div>
              ...
              <div class="listItem">
                <a href="">
                  <img
                    id="listItem7"
                    src="../image/homepage/c356751aea477c350e860deea349bbfb_1.jpg"
                    alt=""
                  />
                </a>
              </div>
              ...
              <div class="listItem">
                <a href="">
                  <img
                    id="listItem8"
                    src="../image/homepage/1e58b94806e47bd6ea25095a723cf0f2_1.jpg"
                    alt=""
                  />
                </a>
              </div>
              ...
              <div class="listItem">
                <a href="">
                  <img
                    id="listItem9"
                    src="../image/homepage/258787a3fdc2a54b7984a1fd7b5c2608_1.jpg"
                    alt=""
                  />
                </a>
              </div>
              ...
              <div class="listItem">
                <a href="">
                  <img
                    id="listItem10"
                    src="../image/homepage/4e7471df31c94d56a331f784fdf40d2c.jpg"
                    alt=""
                  />
                </a>
              </div>
              ...
              <div class="listItem">
                <a href="">
                  <img
                    id="listItem11"
                    src="../image/homepage/df72de10fc9bdd4b5e1347c683894194.jpg"
                    alt=""
                  />
                </a>
              </div>
              ...
              <div class="listItem">
                <a href="">
                  <img
                    id="listItem12"
                    src="../image/homepage/8c8e71f1bbe170e9daec2b195d63bb13_1.jpg"
                    alt=""
                  />
                </a>
              </div>
              ...
              <div class="listItem">
                <a href="">
                  <img
                    id="listItem13"
                    src="../image/homepage/4244cdf71e9ef0bf5d2c32558f6cc171.jpg"
                    alt=""
                  />
                </a>
              </div>
              ...
              <div class="listItem">
                <a href="">
                  <img
                    id="listItem14"
                    src="../image/homepage/9f58fcc96ea63e8e900f4ae8df00b782.jpg"
                    alt=""
                  />
                </a>
              </div>
              ...
              <div class="listItem">
                <a href="">
                  <img
                    id="listItem15"
                    src="../image/homepage/2b91c458982360a43c0e77fd779e9e1a_1.jpg"
                    alt=""
                  />
                </a>
              </div>
              ...
              <div class="listItem">
                <a href="">
                  <img
                    id="listItem16"
                    src="../image/homepage/3de1a3648ce9c41aa383858666ba394b.jpg"
                    alt=""
                  />
                </a>
              </div>
      ...
      <div class="row">
        ...
        <div class="col-lg-12 col-xl-8">
          <section class="single-item">
            ...
            <div>
              <img
                src="../image/homepage/f86ebbc5f9bf8892adfd275d6d892020_compressed_1.jpg"
              />
            </div>
          </section>
        </div>
      ...
      <div class="row">
        ...
        <div class="col-lg-12 col-xl-8">
          ...
          <div
            class="hotItem d-flex align-content-start flex-wrap justify-content-between"
            id="hotItem"
          >
            <div>
            ...
            <div>
              <a href="./product.html" v-bind:id="hotItem[1].id">
            ...
            <div>
              <a href="./product.html" v-bind:id="hotItem[2].id">
            ...
            <div>
              <a href="./product.html" v-bind:id="hotItem[3].id">
            ...
            <div>
              <a href="./product.html" v-bind:id="hotItem[4].id">
            ...
            <div>
              <a href="./product.html" v-bind:id="hotItem[5].id">
            ...
            <div>
              <a href="./product.html" v-bind:id="hotItem[6].id">
            ...
            <div>
              <a href="./product.html" v-bind:id="hotItem[7].id">
      ...
      <div class="row" style="background-color: rgb(215, 100, 131); margin-top: 10px">
        ...
        <div class="col-lg-12 col-xl-8">
          <img
            src="../image/homepage/54643d73abf7b4dc489a60bda52ecbba.jpg"
            alt=""
            style="width: 100%"
          />
        </div>
    ...
    axios
      ...
      .then(function (res) {
        for (let i = 0; i <= 7; i++) {
          ...
          objTemp[i].src = res.data[i].image;
